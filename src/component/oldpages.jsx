...
<div className=" pt-6 pb-10 justify-center items-center inline-flex">
    ...
    <div className="w-[42px] h-10 p-2  rounded justify-center items-center inline-flex">
        <div className="px-2 justify-center items-center gap-2.5 flex">
            <div
                className="text-stone-400 text-base font-medium font-['Roboto'] leading-none tracking-wide">2
            </div>
        </div>
    </div>
    <div className="w-[42px] h-10 p-2 bg-neutral-200 rounded justify-center items-center inline-flex">
        <div className="px-2 justify-center items-center gap-2.5 flex">
            <div
                className="text-stone-400 text-base font-medium font-['Roboto'] leading-none tracking-wide">3
            </div>
        </div>
    </div>
    <div className="w-[42px] h-10 p-2 bg-neutral-200 rounded justify-center items-center inline-flex">
    ...
    <div className="w-[42px] h-10 p-2 bg-neutral-200 rounded justify-center items-center inline-flex">
        <div className="px-2 justify-center items-center gap-2.5 flex">
            <div
                className="text-stone-400 text-base font-medium font-['Roboto'] leading-none tracking-wide">5
            </div>
        </div>
    </div>
    <div className="w-[42px] h-10 p-2 bg-neutral-200 rounded justify-center items-center inline-flex">
        <div className="px-2 justify-center items-center gap-2.5 flex">
            <div
                className="text-stone-400 text-base font-medium font-['Roboto'] leading-none tracking-wide">...
            </div>
        </div>
    </div>
    <div className="w-[42px] h-10 p-2 bg-neutral-200 rounded justify-center items-center inline-flex">
        <div className="px-2 justify-center items-center gap-2.5 flex">
            <div
                className="text-stone-400 text-base font-medium font-['Roboto'] leading-none tracking-wide">11
            </div>
        </div>
    </div>
    ...
    <div className='w-[120px] h-10 p-2 justify-center items-center flex'>
        ...
        <div
            className="text-neutral-400 text-base font-medium font-['Roboto'] leading-none tracking-wide">next
        </div>
